...
public class AlarmDBManager 
{
	...
	private ContentValues buildAlarm(String day, String dest, int prep_time, int alarm_time, int simple)
	{
		...
		values.put("simple", simple);
		
		return values;
	}

	public long createAlarm(String day, String dest, int prep_time, int alarm_time, int simple)
	{
		ContentValues values = buildAlarm(day, dest, prep_time, alarm_time, simple);
		return database.insert("alarms", null, values);
		
	}
	
	public long editAlarm(long alarmId, String day, String dest, int prep_time, int alarm_time, int simple)
	{
		ContentValues values = buildAlarm(day, dest, prep_time, alarm_time, simple);
